...
# coverage run --source='.' --omit='api/migrations/*,PyVideoAPI/*,api/management/*' manage.py test api
...
class RentalEndpoints(TestCase):
    ...
    def test_valid_checkin(self):
        """ Checks in a movie. Increments movie num_available """
